      ...
      <div className={`pt-3 sm:hidden ${showMobileMenu ? 'block' : 'hidden'}`}>
        ...
        <div className="mt-3 py-2 border-t border-gray-200">
          <Button
            ...
            size="md"
            fullWidth
            className={`flex items-center ${isRTL ? 'flex-row-reverse' : 'justify-start'} text-left`}
            icon={<MdLanguage className={`${isRTL ? 'ml-2' : 'mr-2'} text-gray-500`} />}
          >
            {i18n.language === 'en' ? 'العربية' : 'English'}
          </Button>
          ...
          <Button
            ...
            fullWidth
            className={`flex items-center ${isRTL ? 'flex-row-reverse' : 'justify-start'} text-left`}
            icon={<MdSettings className={`${isRTL ? 'ml-2' : 'mr-2'} text-gray-500`} />}
          >
            {t('settings')}
          </Button>
          ...
          <Button
            ...
            fullWidth
            className={`flex items-center ${isRTL ? 'flex-row-reverse' : 'justify-start'} text-left`}
            icon={<MdChat className={`${isRTL ? 'ml-2' : 'mr-2'} text-gray-500`} />}
          >
            {t('support')}
          </Button>
        </div>
