          ...
          return (
            <button
              ...
              className={`
                ...
                transition-all duration-300 ease-in-out
                hover:shadow-md
                ${collapsed ? 'justify-center p-2.5' : isRTL ? 'flex-row-reverse justify-between px-4 py-2.5 text-right' : 'px-4 py-2.5'}
                ${isActive 
            ...
            >
              {!collapsed && (
                <span className={`text-sm font-medium transition-transform duration-300 ${isRTL ? 'ml-2' : 'mr-2'}`}>
                  {t(item.id)}
                </span>
              )}
