                ...
                <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="p-4 bg-gray-50 rounded-lg">
                            <p className="text-sm text-gray-500">{t('Clients.JoinDate')}</p>
                            <p className="font-bold">{client.joinDate}</p>
                        </div>
                        <div className="p-4 bg-gray-50 rounded-lg">
                            <p className="text-sm text-gray-500">{t('Clients.LastOrder')}</p>
                            <p className="font-bold">{client.lastOrder}</p>
                        </div>
                        <div className="col-span-2 p-4 bg-gray-50 rounded-lg">
                            <p className="text-sm text-gray-500">{t('Clients.TotalSpent')}</p>
