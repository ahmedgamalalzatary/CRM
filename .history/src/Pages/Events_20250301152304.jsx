...
function Events() {
    ...
    const eventStats = [
        { title: t('Events.Stats.TotalEvents'), value: '24', icon: MdEvent, color: 'bg-purple-100 text-purple-800' },
        { title: t('Events.Stats.Today'), value: '3', icon: MdToday, color: 'bg-blue-100 text-blue-800' },
        { title: t('Events.Stats.Upcoming'), value: '12', icon: MdUpcoming, color: 'bg-green-100 text-green-800' },
        { title: t('Events.Stats.Past'), value: '9', icon: MdHistory, color: 'bg-gray-100 text-gray-800' },
    ];

    const allEvents = [
        { id: 1, title: 'Product Launch', date: '2024-02-01', time: '10:00 AM', attendees: 50, type: t('Events.Types.Corporate'), location: 'Main Conference Room' },
        { id: 2, title: 'Team Meeting', date: '2024-01-25', time: '2:00 PM', attendees: 15, type: t('Events.Types.Internal'), location: 'Meeting Room B' },
        { id: 3, title: 'Client Workshop', date: '2024-01-30', time: '9:30 AM', attendees: 25, type: t('Events.Types.Training'), location: 'Training Center' },
        { id: 4, title: 'Sales Conference', date: '2024-02-15', time: '9:00 AM', attendees: 100, type: t('Events.Types.Corporate'), location: 'Convention Center' },
        { id: 5, title: 'Staff Training', date: '2024-01-28', time: '1:00 PM', attendees: 30, type: t('Events.Types.Training'), location: 'Meeting Room A' },
    ];
