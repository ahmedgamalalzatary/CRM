...
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, AreaChart, Area, LineChart, Line, ResponsiveContainer } from 'recharts';
import { 
                                                                ...
                                                                {recentTransactions.map((tx) => (
                                                                    <div key={tx.id}
                                                                        ...
                                                                        <div className="flex items-center space-x-3">
                                                                            <div className={`p-2 rounded-full ${tx.trend === 'up' ? 'bg-gray-100' : 'bg-gray-100'
                                                                                }`}>
                                                                                {tx.trend === 'up' ?
