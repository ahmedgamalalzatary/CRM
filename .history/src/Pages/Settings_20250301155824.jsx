                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="border rounded-lg p-4">
                                <h4 className="font-medium text-gray-800 mb-2">{t('Settings.Backup.ManualBackup')}</h4>
                                <p className="text-sm text-gray-600 mb-4">{t('Settings.Backup.ManualBackupDesc')}</p>
                            ...
                            <div className="border rounded-lg p-4">
                                <h4 className="font-medium text-gray-800 mb-2">{t('Settings.Backup.ScheduledBackups')}</h4>
                                <p className="text-sm text-gray-600 mb-4">{t('Settings.Backup.ScheduledBackupsDesc')}</p>
                                <div className="flex items-center justify-between mb-4">
                                    <span className="text-sm font-medium">{t('Settings.Backup.EnableAutoBackup')}</span>
                                    <label className="relative inline-flex items-center cursor-pointer">
                                ...
                                <select className="w-full p-2 border rounded-lg">
                                    <option>{t('Settings.Backup.Weekly')}</option>
                                    <option>{t('Settings.Backup.Monthly')}</option>
                                    <option>{t('Settings.Backup.Quarterly')}</option>
                                </select>
                            </div>
                        </div>
                        
                        <div className="border-t pt-6">
                            <h3 className="text-lg font-semibold mb-4">{t('Settings.Backup.DataManagement')}</h3>
                            <div className="space-y-4">
                                <div className="p-4 border rounded-lg flex items-center justify-between">
                                    <div>
                                        <p className="font-medium text-gray-800">{t('Settings.Backup.ImportData')}</p>
                                        <p className="text-sm text-gray-500">{t('Settings.Backup.ImportDataDesc')}</p>
                                    </div>
                                    <Button variant="secondary">{t('Settings.Backup.Import')}</Button>
                                </div>
                                
                                <div className="p-4 border border-red-200 rounded-lg flex items-center justify-between">
                                    <div>
                                        <p className="font-medium text-red-600">{t('Settings.Backup.DeleteAllData')}</p>
                                        <p className="text-sm text-red-500">{t('Settings.Backup.DeleteAllDataDesc')}</p>
                                    </div>
                                    <Button 
                                        variant="secondary" 
                ...
                <Card hover className="transition-all duration-300 hover:-translate-y-1">
                    <div className="flex items-center justify-between p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-gray-800">{t('Settings.QuickToggles.EmailNotifications')}</span>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input 
                                type="checkbox" 
                ...
                <Card hover className="transition-all duration-300 hover:-translate-y-1">
                    <div className="flex items-center justify-between p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-gray-800">{t('Settings.QuickToggles.DarkMode')}</span>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input 
                                type="checkbox" 
                ...
                <Card hover className="transition-all duration-300 hover:-translate-y-1">
                    <div className="flex items-center justify-between p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-gray-800">{t('Settings.QuickToggles.Language')}</span>
                        </div>
                        <select 
