...
import { MdWarehouse, MdLocalShipping, MdWarning, MdAddBox, MdOutlineQrCodeScanner, MdRefresh, 
  MdFilterList, MdSearch, MdEdit, MdDelete, MdInventory, MdHistory, MdImportExport, MdDownload } from 'react-icons/md';
        ...
        <div className="space-y-6">
            ...
            <Card>
                <Table>
                    <TableHead>
                        <TableRow>
                            <TableHeader>{t('products.productName')}</TableHeader>
                            <TableHeader>{t('inventory.currentStock')}</TableHeader>
                            <TableHeader>{t('inventory.minimumStock')}</TableHeader>
                            <TableHeader>{t('inventory.supplier')}</TableHeader>
                            <TableHeader>{t('inventory.location')}</TableHeader>
                            <TableHeader>{t('inventory.lastRestocked')}</TableHeader>
