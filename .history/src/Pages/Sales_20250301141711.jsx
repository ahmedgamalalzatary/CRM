...
function Sales() {
    ...
    const [salesData, setSalesData] = useState([
        { id: 1, customer: t('customers.johnDoe'), product: t('productOptions.productA'), amount: 1200, date: '2023-01-15' },
        { id: 2, customer: t('customers.janeSmith'), product: t('productOptions.productB'), amount: 850, date: '2023-01-16' },
        { id: 3, customer: t('customers.bobJohnson'), product: t('productOptions.productC'), amount: 2300, date: '2023-01-17' },
        { id: 4, customer: t('customers.aliceWilliams'), product: t('productOptions.productA'), amount: 750, date: '2023-01-20' },
        { id: 5, customer: t('customers.davidWilson'), product: t('productOptions.productB'), amount: 1450, date: '2023-01-22' },
    ]);
    ...
    const salesMetrics = {
        recentOrders: [
            { id: 1, customer: t('customers.johnDoe'), status: t('status.processing'), time: t('timeAgo.2min') },
            { id: 2, customer: t('customers.janeSmith'), status: t('status.completed'), time: t('timeAgo.5min') },
            { id: 3, customer: t('customers.bobJohnson'), status: t('status.pending'), time: t('timeAgo.10min') },
        ],
        topCustomers: [
        ...
        <div className="space-y-8">
            ...
            >
                <Card hover className="transform transition-all duration-300 hover:-translate-y-1">
                    <h3 className="font-semibold text-gray-800 mb-4">{t('salesData.recentOrders')}</h3>
                ...
                <Card hover className="transform transition-all duration-300 hover:-translate-y-1">
                    <h3 className="font-semibold text-gray-800 mb-4">{t('salesData.topCustomers')}</h3>
                    <div className="space-y-4">
                        {salesMetrics.topCustomers.map((customer) => (
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">{customer.orders} {t('salesData.orders')}</p>
                                </div>
                ...
                <Card hover className="p-4 transition-all duration-300 hover:shadow-md">
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            aria-label={t('salesData.filterByDate')}
                        >
                            <option value="all">{t('salesData.filterByDate')}</option>
                            <option value="today">{t('salesData.today')}</option>
                            <option value="week">{t('salesData.thisWeek')}</option>
                            <option value="month">{t('salesData.thisMonth')}</option>
                        </select>
                    </div>
                </Card>
                ...
                <Card hover className="p-4 transition-all duration-300 hover:shadow-md">
                    <div className="flex items-center gap-2">
                        ...
                        <input
                            ...
                            placeholder={t('salesData.searchSales')}
                            className="w-full p-2 border border-gray-200 rounded focus:outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-500 transition-colors duration-300"
                            aria-label={t('salesData.searchSales')}
                        />
                    </div>
                </Card>
                ...
                <Card hover className="p-4 transition-all duration-300 hover:shadow-md">
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            aria-label={t('salesData.filterByProduct')}
                        >
            ...
            >
                {[
                    ...
                    { title: t('sales.topProduct'), value: t('productOptions.productA'), icon: MdTrendingUp, color: 'text-yellow-500' }
                ].map((stat, index) => (
                    <Card 
                        key={index} 
                        hover 
