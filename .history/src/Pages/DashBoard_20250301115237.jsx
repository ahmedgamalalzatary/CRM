                    ...
                    <Card hover>
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <div className="flex space-x-2">
                                <Button variant="ghost" size="xs" className="bg-gray-100 text-gray-700">Weekly</Button>
                                <Button variant="dark" size="xs">Monthly</Button>
                                <Button variant="ghost" size="xs" className="bg-gray-100 text-gray-700">Yearly</Button>
                            </div>
                        </div>
                        <div className="h-64">
