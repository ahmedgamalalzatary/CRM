...
function Employees() {
    ...
    const employees = [
        { id: 1, name: 'John Doe', position: t('Employees.Departments.Sales') + ' Manager', department: t('Employees.Departments.Sales'), status: t('Employees.Status.Active') },
        { id: 2, name: 'Jane Smith', position: 'Support Specialist', department: t('Employees.Departments.CustomerSupport'), status: t('Employees.Status.Active') },
        { id: 3, name: 'Mike Wilson', position: 'Developer', department: t('Employees.Departments.IT'), status: t('Employees.Status.OnLeave') },
        { id: 4, name: 'Sarah Johnson', position: t('Employees.Departments.Marketing') + ' Manager', department: t('Employees.Departments.Marketing'), status: t('Employees.Status.Active') },
        { id: 5, name: 'Robert Davis', position: t('Employees.Departments.Product') + ' Manager', department: t('Employees.Departments.Product'), status: t('Employees.Status.OnLeave') },
    ];
                    ...
                    >
                        ...
                        <div className="space-y-3"></div>
                            {employees.filter(emp => emp.department === dept).map(emp => (
                                <div key={emp.id} className="flex items-center justify-between hover:bg-gray-50 p-2 rounded transition-colors duration-200"></div>
