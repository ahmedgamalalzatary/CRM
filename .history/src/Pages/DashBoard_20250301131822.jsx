...
function DashBoard({ setActivePage }) {
    ...
    const quickActions = [
        { label: t('addSale'), page: 'sales', icon: MdAttachMoney },
        { label: t('addNewProduct'), page: 'products', icon: MdShoppingCart },
        { label: t('addClient'), page: 'clients', icon: MdPeople },
                    ...
                    <Card hover>
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <div className="flex space-x-2">
                                <Button variant="ghost" size="xs" className="bg-gray-100 text-gray-700">{t('weekly')}</Button>
                                <Button variant="dark" size="xs">{t('monthly')}</Button>
                                <Button variant="ghost" size="xs" className="bg-gray-100 text-gray-700">{t('yearly')}</Button>
                            </div>
                        </div>
                        <div className="h-64">
