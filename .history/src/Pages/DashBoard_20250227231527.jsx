...
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, AreaChart, Area, LineChart, Line, ResponsiveContainer, Cell, PieChart, Pie } from 'recharts';
import { 
...
function DashBoard({ setActivePage }) {
    ...
    // For Line Chart in trends section
    const trendData = [
        { month: 'Jan', customers: 65, orders: 85 },
        { month: 'Feb', customers: 78, orders: 92 },
        { month: 'Mar', customers: 72, orders: 88 },
        { month: 'Apr', customers: 85, orders: 110 },
        { month: 'May', customers: 92, orders: 120 },
        { month: 'Jun', customers: 100, orders: 135 },
    ];
    ...
    return (
        <div className="space-y-6 max-w-full overflow-x-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-lg p-6 text-white"></div>
