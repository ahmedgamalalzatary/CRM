...
const resources = {
  en: {
    translation: {
      ...
      'inventory.filter': 'Filter by Status',
      ...
      'inventory.noResults': 'No inventory items found',
  ...
  ar: {
    translation: {
      ...
      'products.lastUpdated': 'آخر تحديث',
      ...
      'inventory.filter': 'تصفية حسب الحالة',
      ...
      'inventory.lastRestocked': 'آخر تجديد للمخزون',
      'inventory.supplier': 'المورد',
      'inventory.location': 'الموقع',
      'inventory.status': 'الحالة',
      'inventory.actions': 'الإجراءات',
      'inventory.noResults': 'لم يتم العثور على عناصر في المخزون',
      'inventory.stockHistory': 'سجل المخزون',
      ...
      'inventory.status.outOfStock': 'نفذ من المخزون',
      'inventory.status.discontinued': 'متوقف'
    }
  }
};
